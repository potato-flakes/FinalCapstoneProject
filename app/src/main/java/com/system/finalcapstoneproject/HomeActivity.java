...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final String[] PLASTIC_TITLES = {"Have you heard?", "Did you know?", "Did you know?", "Did you know?", "Did you know?", "Did you know?", "Did you know?", "Did you know?", "Did you know?"};
    private static final String[] PLASTIC_NAMES = {"Forging Partnerships for a Greener Future! ", "Polyethylene Terephthalate", "High Density Polyethylene", "Polyvinyl Chloride Plastic Type", "Low density polyethylene", "Polypropolene", "Polystyrene", "Burning of plastic", "Other plastics"};
